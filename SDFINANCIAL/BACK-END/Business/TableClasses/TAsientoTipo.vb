...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into AsientoTipo( Emp_Id , Tipo_Id" & _
                    " , Nombre , Activo" & _
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From AsientoTipo" & _
                    " Where Emp_Id = " & _Emp_Id.ToString & _
                    " And   Tipo_Id = " & _Tipo_Id.ToString
    ...
    Public Overrides Function LoadComboBox() As String
        ...
        Try
            ...
            Query = "select Tipo_Id as Numero, Nombre From AsientoTipo" & _
    ...
    Public Overrides Function ListMant(pNombre As String) As String
        ...
        Try
            ...
            Query = "select Tipo_Id as Codigo, Nombre From AsientoTipo" & _
                    " where Emp_Id = " & _Emp_Id.ToString
    ...
    Public Overrides Function NextOne() As String
        ...
        Try
            ...
            Query = "select IsNull(MAX(Tipo_Id),0) + 1 as Tipo_Id From AsientoTipo" & _
                    " Where Emp_Id = " & _Emp_Id.ToString
