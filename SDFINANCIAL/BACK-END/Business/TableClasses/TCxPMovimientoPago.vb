...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into CxPMovimientoPago( Emp_Id , Tipo_Id" & _
                    " , Mov_Id , Pago_Id" & _
                    " , TipoPago_Id , Monto" & _
                    " , Banco_Id , ChequeNumero" & _
                    " , ChequeFecha , DepositoNumero" & _
                    " , DepositoFecha , TransferenciaNumero" & _
                    " , Tarjeta_Id , TarjetaNumero" & _
                    " , TarjetaAutorizacion , Moneda" & _
                    ...
                    ",'" & Format(_ChequeFecha, "yyyyMMdd HH:mm:ss") & "'" & ",'" & _DepositoNumero & "'" & _
                    ",'" & Format(_DepositoFecha, "yyyyMMdd HH:mm:ss") & "'" & ",'" & _TransferenciaNumero & "'" & _
                    "," & _Tarjeta_Id.ToString & ",'" & _TarjetaNumero & "'" & _
                    ",'" & _TarjetaAutorizacion & "'" & ",'" & _Moneda & "'" & _
                    "," & _TipoCambio.ToString & "," & _Dolares.ToString & _
                    ",'" & Format(_Fecha, "yyyyMMdd HH:mm:ss") & "'" & "," & _Batch_Id.ToString & ")"
    ...
    Public Overrides Function Delete() As String
        ...
        Try
            ...
            Query = "Delete CxPMovimientoPago" & _
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " Update CxPMovimientoPago " & _
                    " SET    TipoPago_Id = " & _TipoPago_Id & "," & _
                    " Monto = " & _Monto & "," & _
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From CxPMovimientoPago" & _
                    " Where Emp_Id = " & _Emp_Id.ToString & _
                    " And   Tipo_Id = " & _Tipo_Id.ToString & _
                    " And   Mov_Id = " & _Mov_Id.ToString & _
                    " And   Pago_Id = " & _Pago_Id.ToString
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select * From CxPMovimientoPago"
    ...
    Public Overrides Function LoadComboBox() As String
        ...
        Try
            ...
            Query = "select Pago_Id as Numero, Nombre From CxPMovimientoPago"
    ...
    Public Overrides Function ListMant(pNombre As String) As String
        ...
        Try
            ...
            Query = "select Pago_Id as Codigo, Nombre From CxPMovimientoPago" & _
    ...
    Public Overrides Function NextOne() As String
        ...
        Try
            ...
            Query = "select IsNull(MAX(Pago_Id),0) + 1 as Pago_Id From CxPMovimientoPago" & _
                    " Where Emp_Id = " & _Emp_Id.ToString & _
                    " And   Tipo_Id = " & _Tipo_Id.ToString & _
