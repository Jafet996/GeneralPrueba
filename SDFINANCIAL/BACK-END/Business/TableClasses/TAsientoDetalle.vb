...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into AsientoDetalle( Emp_Id , Asiento_Id" & _
                    " , Linea_Id , Fecha" & _
                    " , Moneda , CC_Id" & _
                    " , Cuenta_Id , Tipo" & _
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = " select a.*" & _
                    ...
                    " ,c.Nombre as CC_Nombre" & _
                    " From AsientoDetalle a" & _
                    " inner join Cuenta b on a.Emp_Id = b.Emp_Id And a.Cuenta_Id = b.Cuenta_Id" & _
                    " left join CentroCosto c on a.Emp_Id = c.Emp_Id And a.CC_Id = c.CC_Id" & _
                    " Where a.Emp_Id = " & _Emp_Id.ToString & _
                    " And   a.Asiento_Id = " & _Asiento_Id.ToString & _
                    " And   a.Linea_Id = " & _Linea_Id.ToString
    ...
    Public Overrides Function LoadComboBox() As String
        ...
        Try
            ...
            Query = "select AsientoDetalle_Id as Numero, Nombre From AsientoDetalle"
    ...
    Public Overrides Function ListMant(pNombre As String) As String
        ...
        Try
            ...
            Query = "select AsientoDetalle_Id as Codigo, Nombre From AsientoDetalle" & _
    ...
    Public Overrides Function NextOne() As String
        ...
        Try
            ...
            Query = "select IsNull(MAX(AsientoDetalle_Id),0) + 1 as AsientoDetalle_Id From AsientoDetalle" & _
                    " Where Emp_Id = " & _Emp_Id.ToString & _
