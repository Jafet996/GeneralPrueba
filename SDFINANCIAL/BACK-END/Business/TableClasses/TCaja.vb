...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into Caja( Emp_Id , Caja_Id" & _
                    " , Nombre , Abierta" & _
                    " , Cierre_Id , Activo" & _
                    " , UltimaModificacion )" & _
                    " Values ( " & _Emp_Id.ToString & "," & _Caja_Id.ToString & _
                    ",'" & _Nombre & "'" & "," & _Abierta.ToString & _
                    "," & _Cierre_Id.ToString & "," & _Activo.ToString & _
                    ",GETDATE()" & ")"
    ...
    Public Overrides Function LoadComboBox() As String
        ...
        Try
            ...
            Query = "select Caja_Id as Numero, Nombre From Caja"
    ...
    Public Overrides Function ListMant(pNombre As String) As String
        ...
        Try
            ...
            Query = "select Caja_Id as Codigo, Nombre From Caja" & _
    ...
    Public Overrides Function NextOne() As String
        ...
        Try
            ...
            Query = "select IsNull(MAX(Caja_Id),0) + 1 as Caja_Id From Caja" & _
                    " Where Emp_Id = " & _Emp_Id.ToString
