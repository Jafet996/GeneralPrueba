...
#Region "Definicion metodos publicos"
    ...
    Public Overrides Function ListMant(pNombre As String) As String
        ...
        Try
            ...
            Query = "select PermisoBitacora_Id as Codigo, Nombre From PermisoBitacora" & _
    ...
    Public Overrides Function NextOne() As String
        ...
        Try
            ...
            Query = "select IsNull(MAX(PermisoBitacora_Id),0) + 1 as PermisoBitacora_Id From PermisoBitacora"
