...
#Region "Definicion Variables Locales"
    ...
    Private _DTabla As New SDFinancial.DTAsientoTipo
...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.Insertar, String.Empty)
    ...
    Public Overrides Function Delete() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.Eliminar, String.Empty)
    ...
    Public Overrides Function Modify() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.Modificar, String.Empty)
    ...
    Public Overrides Function ListKey() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.ListKey, String.Empty)
            ...
            If Not _Resultado.Datos Is Nothing AndAlso _Resultado.Datos.Rows.Count > 0 Then
                ...
                _Activo = _Resultado.Datos.Rows(0).Item("Actrivo")
    ...
    Public Overrides Function List() As String
        Try
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.List, String.Empty)
    ...
    Public Overrides Function LoadComboBox(pCombo As Windows.Forms.ComboBox) As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.LoadCombo, String.Empty)
    ...
    Public Overrides Function ListMant(pCriterio As String) As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.ListMant, pCriterio)
    ...
    Public Overrides Function NextOne() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoTipoMant(_DTabla, SDFinancial.EnumOperacionMant.NextOne, String.Empty)
