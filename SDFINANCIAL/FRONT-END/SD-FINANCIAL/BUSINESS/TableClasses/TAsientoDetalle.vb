...
#Region "Definicion Variables Locales"
    ...
    Private _CC_Nombre As String
    Private _SDWCF As New SDFinancial.SDFinancial
    Private _DTabla As New SDFinancial.DTAsientoDetalle
...
#Region "Definicion de propiedades"
    ...
    Public Property CuentaNombre As String
        ...
        End Set
    End Property
    Public Property CC_Nombre As String
        Get
            Return _CC_Nombre
        End Get
        Set(value As String)
...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.Insertar, String.Empty)
    ...
    Public Overrides Function Delete() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.Eliminar, String.Empty)
    ...
    Public Overrides Function Modify() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.Modificar, String.Empty)
    ...
    Public Overrides Function ListKey() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.ListKey, String.Empty)
            ...
            If Not _Resultado.Datos Is Nothing AndAlso _Resultado.Datos.Rows.Count > 0 Then
                ...
                _CuentaNombre = _Resultado.Datos.Rows(0).Item("CuentaNombre")
                _CC_Nombre = _Resultado.Datos.Rows(0).Item("CC_Nombre")
            End If
    ...
    Public Overrides Function List() As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.List, String.Empty)
    ...
    Public Overrides Function LoadComboBox(pCombo As Windows.Forms.ComboBox) As String
        Try
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.LoadCombo, String.Empty)
    ...
    Public Overrides Function ListMant(pCriterio As String) As String
        Try
            ...
            _Resultado = _SDWCF.AsientoDetalleMant(_DTabla, SDFinancial.EnumOperacionMant.ListMant, pCriterio)
