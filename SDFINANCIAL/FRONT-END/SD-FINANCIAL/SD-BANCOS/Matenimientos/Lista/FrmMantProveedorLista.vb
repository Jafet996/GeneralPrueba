...
#Region "Variables"
    ...
    Private _ProveedorNuevo As Integer = 0
#End Region
#Region "Propiedades"
    ...
    Public ReadOnly Property GuardoCambios As Boolean
        ...
        End Get
    End Property
    Public ReadOnly Property ProveedorNuevo As Boolean
        Get
            Return _ProveedorNuevo
        End Get
    End Property
#End Region
    ...
    Private Sub TxtCriterio_TextChanged(sender As Object, e As EventArgs) Handles TxtCriterio.TextChanged
        If TxtCriterio.Text.Trim <> "" Then
            PicBorrar.Image = Global.SDBANCOS.My.Resources.delete
        Else
