...
#End Region
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            VerificaMensaje(Tarjeta.ListMant(TxtCriterio.Text.Trim))

            DGDetalle.DataSource = Tarjeta.Datos.Tables(0)
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            With Tarjeta
                ...
                .Tarjeta_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            End With
