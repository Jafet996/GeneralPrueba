...
Public Class RptComprobanteTransferencia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptComprobanteTransferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDBANCOS.RptComprobanteTransferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pBcoPago_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptComprobanteTransferencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptComprobanteTransferencia = New RptComprobanteTransferencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
