...
Public Class RptCxCAsignarFacturasVendedores
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptCxCAsignarFacturasVendedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDCXC.RptCxCAsignarFacturasVendedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pEntrega_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCxCAsignarFacturasVendedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCxCAsignarFacturasVendedores = New RptCxCAsignarFacturasVendedores()
        rpt.Site = Me.Site
        Return rpt
    End Function
