Imports BUSINESS
Public Class FrmRptMovimientosPorCliente
#Region "Variables"
...
#End Region
    ...
    Private Sub MuestraReporte()
        ...
        Dim Reporte As New RptCxCEstadoCuentaCliente
        ...
        Try
            ...
            End With
            VerificaMensaje(Movimiento.RptMovimientoPorCliente(DpDesde.Value, DpHasta.Value))
    ...
    Private Sub MuestraReporteTectel()
        Dim Movimiento As New TCxCMovimiento
        Dim Reporte As New RptCxCEstadoCuentaClienteTectel
        Dim FormaReporte As New FrmReporte
        Dim Fecha As DateTime
