Imports BUSINESS
Public Class FrmMantCuentaTipoLista
#Region "Variables"
    Private coTitulo = "Tipo de Cuenta"
#End Region
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            VerificaMensaje(CuentaTipo.ListMant(TxtCriterio.Text.Trim))

            DGDetalle.DataSource = CuentaTipo.Datos.Tables(0)
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantCuentaTipoDetalle
