Imports BUSINESS
Public Class FrmRptEstadoResultados
    Public Sub Execute()
        CargaCombo()
    ...
    Private Sub MuestraReporte()
        ...
        Try
            ...
            End With
            VerificaMensaje(Cuenta.RptEstadoResultados(CInt(CmbAnnio.Text.Trim), MesNumero(CmbMes.Text.Trim)))
            ...
            Reporte.SetParameterValue("@Detallado", ChkDetallado.Checked)
    ...
    Private Sub FrmRptEstadoResultados_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
