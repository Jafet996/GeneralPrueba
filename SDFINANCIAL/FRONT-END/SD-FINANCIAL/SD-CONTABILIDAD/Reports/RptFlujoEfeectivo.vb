...
Public Class RptFlujoEfeectivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDCONTABILIDAD.RptFlujoEfeectivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFlujoEfeectivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFlujoEfeectivo = New RptFlujoEfeectivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
