...
Public Class RptEmpresaLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDCONTABILIDAD.RptEmpresaLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEmpresaLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEmpresaLogo = New RptEmpresaLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function
