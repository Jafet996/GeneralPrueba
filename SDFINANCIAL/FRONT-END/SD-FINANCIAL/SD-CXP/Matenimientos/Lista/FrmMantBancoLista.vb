...
#End Region
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            VerificaMensaje(Banco.ListMant(TxtCriterio.Text.Trim))

            DGDetalle.DataSource = Banco.Datos.Tables(0)
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            With Banco
                ...
                .Banco_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            End With
