        ...
        Try
            ...
            Select Case _Moneda
                Case coMonedaColones
                    ...
                    LblSignoDolar.Visible = False
                    LblTipoCambioEnc.Visible = False
            ...
            If _Maximo > 0 Then
                If _Moneda = coMonedaColones Then
                    If CDbl(TxtMonto.Text.Trim) > _Maximo Then
                        VerificaMensaje("El monto digitado no puede no puede ser mayor a ¢" & _Maximo)
                    End If
    ...
    Private Sub Aceptar()
        Try
            If ValidaMonto() Then
                ...
                If _Moneda = coMonedaDolares Then _Dolares = CDbl(TxtDolares.Tag)
                Me.Close()
            End If
        Catch ex As Exception
            MensajeError(ex.Message)
