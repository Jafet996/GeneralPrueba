...
#End Region
    ...
    Private Sub Buscar()
        ...
        Try
            ...
            VerificaMensaje(Proveedor.ListBusqueda(TxtCriterio.Text.Trim, TipoBusqueda))
    ...
    Private Sub Seleccionar()
        Try
            ...
            _Prov_Id = CInt(DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value)
            _Selecciono = True
    ...
    Private Sub FrmBusquedaProveedor_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Select Case e.KeyCode
            Case Keys.Escape
                Me.Close()
        End Select
