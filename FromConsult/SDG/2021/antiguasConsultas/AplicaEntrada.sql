...
/****** Object:  StoredProcedure [dbo].[AplicaEntrada]    Script Date: 1/22/2021 3:56:52 PM ******/
SET ANSI_NULLS ON
GO
...
begin
  begin try
    ...
    while @@fetch_status = 0 begin
      ...
      exec @SpResult = RebajaSumaIventario @pEmp_Id, @pSuc_Id, @Bod_Id, @Art_Id ,@Cantidad, 'Entrada de Mercadería', @pUsuario_Id, @NombreProveedor,'', ''
      if @SpResult<>0 begin
