...
/****** Object:  StoredProcedure [dbo].[GuardaFacturaDetalle]    Script Date: 1/25/2021 8:32:20 AM ******/
SET ANSI_NULLS ON
GO
...
begin
  begin try
    ...
    exec @SpResult = RebajaSumaIventario @pEmp_Id, @pSuc_Id, @pBod_Id, @pArt_Id ,@pCantidad, @Nombre, @pUsuario_Id, @pNombreEntidad, @pConsecutivo, @pClave 
    if @SpResult<>0 begin
