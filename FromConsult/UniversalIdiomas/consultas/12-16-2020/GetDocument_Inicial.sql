USE [UniversalProduccion]
GO

/****** Object:  StoredProcedure [dbo].[FE_GetDocument]    Script Date: 12/16/2020 11:05:24 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE   PROCEDURE [dbo].[FE_GetDocument]
(
  @pCantidad smallint
)
AS
  BEGIN
    ...
    Begin Try
      ...
      INNER JOIN ReciboDinero b ON a.Emp_Id = b.Emp_Id and a.ReciboDinero_Id = b.ReciboDinero_Id
      INNER JOIN Estudiante c ON b.Emp_Id = c.Emp_Id and b.Estudiante_Id = c.Estudiante_Id
      INNER JOIN FE_Parametros d ON b.Emp_Id = d.Emp_Id and b.Suc_Id = d.Suc_Id
      where a.Procesar  = 1
      and   a.Procesado = 0
      ...
      select b.Emp_Id
            ...
            ,SUBSTRING(c.Nombre + ' (Mensualidad ' + CONVERT(varchar, b.Cuota_id) + ') ' + CONVERT(varchar, d.FechaCuotaDesde, 103) + ' - ' + CONVERT(varchar, d.FechaCuotaHasta, 103), 1, 160) -- Detalle
            ,1 -- Cantidad
            ...
            ,@PorcCuota
      from #ReciboDinero a
      INNER JOIN ReciboDineroCuota b ON a.Emp_Id = b.Emp_Id and a.ReciboDinero_Id = b.ReciboDinero_Id
      INNER JOIN Grupo c ON b.Emp_Id = c.Emp_Id and b.Grupo_Id = c.Grupo_Id
      INNER JOIN EstudianteGrupoCuota d ON b.Emp_Id = d.Emp_Id and b.Estudiante_Id = d.Estudiante_Id and b.Grupo_Id = d.Grupo_Id and b.Item_Id = d.Item_Id and b.Cuota_Id = d.Cuota_Id
      ...
      select b.Emp_Id
            ...
            ,0 -- Porcentaje de ccompra exonerado
      from #ReciboDinero a
      INNER JOIN ReciboDineroProducto b ON a.Emp_Id = b.Emp_Id and a.ReciboDinero_Id = b.ReciboDinero_Id
      INNER JOIN Producto c ON b.Emp_Id = c.Emp_Id and b.Producto_Id = c.Producto_Id
      INNER JOIN Empresa d ON b.Emp_Id = d.Emp_Id
