Imports Business
Public Class FrmMantLoteLista
    Private coTitulo = "Lote"
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Lote.ListaMantenimiento(TxtCriterio.Text.Trim)
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = Lote.Data.Tables(0)

            DGDetalle.Columns(0).HeaderText = "Código"
            DGDetalle.Columns(1).HeaderText = "Número"
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantLoteDetalle
    ...
    Private Sub GroupLista_Enter(sender As Object, e As EventArgs) Handles GroupLista.Enter
