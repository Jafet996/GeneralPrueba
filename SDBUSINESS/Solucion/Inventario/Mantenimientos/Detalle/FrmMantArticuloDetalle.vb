Imports Business
Public Class FrmMantArticuloDetalle
...
#End Region
    ...
    Private Sub BtnPrecios_Click(sender As System.Object, e As System.EventArgs) Handles BtnPrecios.Click
        ...
        Dim Mensaje As String = ""
        Try
            If Not VerificaPermiso(EmpresaInfo.Emp_Id, SucursalInfo.Suc_Id, UsuarioInfo.Usuario_Id, Permisos.AccesoPrecio, False) Then
    ...
    Private Sub BtnCosto_Click(sender As System.Object, e As System.EventArgs) Handles BtnCosto.Click
        ...
        Try
            If Not VerificaPermiso(EmpresaInfo.Emp_Id, SucursalInfo.Suc_Id, UsuarioInfo.Usuario_Id, Permisos.AccesoCosto, False) Then
