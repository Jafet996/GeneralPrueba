...
Public Class GeneraEtiqueraIVP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario.GeneraEtiqueraIVP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGeneraEtiqueraIVP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneraEtiqueraIVP = New GeneraEtiqueraIVP()
        rpt.Site = Me.Site
        Return rpt
    End Function
