...
Public Class TrasladoInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario.TrasladoInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTraslado_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTrasladoInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrasladoInventario = New TrasladoInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
