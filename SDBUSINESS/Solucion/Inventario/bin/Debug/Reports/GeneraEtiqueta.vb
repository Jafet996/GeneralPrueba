...
Public Class GeneraEtiqueta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario.GeneraEtiqueta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pCedulaJuridica() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedGeneraEtiqueta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneraEtiqueta = New GeneraEtiqueta()
        rpt.Site = Me.Site
        Return rpt
    End Function
