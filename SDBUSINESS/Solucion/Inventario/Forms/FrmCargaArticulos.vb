...
#End Region
    ...
    Private Sub Aplicar()
        ...
        Dim ListaTmp As New List(Of TArticuloConteo)
        Try
            ...
            For Each item As ListViewItem In LvwDetalle.Items
                ...
                With Conteo
                    ...
                    .Descripcion = item.SubItems(1).Text.Trim
                    If Not IsNumeric(item.SubItems(2).Text.Trim) Then
                        .Cantidad = 0
                    Else
            ...
            Dim otherRecords = (From lst In _ListaConteo
                                Select lst
                                Order By lst.Descripcion)


            For Each Con As TArticuloConteo In otherRecords
                ListaTmp.Add(Con)
            Next


            _ListaConteo = ListaTmp
