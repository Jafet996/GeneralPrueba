Imports Business
Public Class FrmBuscaArticuloCompuesto
    Private _Art_Id As String
    Private _SaldoPropio As Integer

    Public WriteOnly Property SaldoPropio As Integer
    ...
    Private Sub Buscar()
        ...
        Try
            ...
            Mensaje = Articulo.ListBusquedaArticuloCompuestoInventario(TxtCriterio.Text.Trim, _SaldoPropio)
