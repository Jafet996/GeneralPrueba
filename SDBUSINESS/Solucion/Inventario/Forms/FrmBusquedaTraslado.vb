...
#Region "Propiedades"
    Public ReadOnly Property Selecciono As Boolean
        ...
        End Get
    End Property
    Public ReadOnly Property Traslado_Id As Long
        Get
            Return _Traslado_Id
        End Get
    End Property
...
#Region "Funciones privadas"
    Private Sub Seleccionar()
        Try
            ...
            _Traslado_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
...
#End Region
    ...
    Private Sub CargaCombos()
        ...
        Try
            ...
            Sucursal.LoadComboBox(CmbSucursalOrigen)
    ...
    Private Sub Buscar()
        ...
        Try
            ...
            ElseIf RdbFechas.Checked Then
                TipoBusqueda = 2
            ElseIf RdbSucursalOrigen.Checked Then
                TipoBusqueda = 3
            End If


            Mensaje = TrasladoEncabezado.ListBusqueda(TipoBusqueda, CInt(TxtCantidad.Text), DateValue(DtpDesde.Value), DateValue(DtpHasta.Value), CmbSucursalOrigen.SelectedValue)
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = TrasladoEncabezado.Data.Tables(0)
            DGDetalle.Columns(0).Width = 80
            DGDetalle.Columns(1).Width = 150
