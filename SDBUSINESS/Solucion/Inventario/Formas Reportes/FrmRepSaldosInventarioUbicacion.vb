Imports Business
Public Class FrmRepSaldosInventarioUbicacion
    ...
    Private Sub MuestraReporte()
        ...
        Dim Reporte As New SaldosInventarioUbicacion
        ...
        Try
            ...
            Mensaje = ArticuloBodega.RptSaldosInventarioUbicacion(TxtUbicacionIni.Text.Trim, TxtUbicacionFin.Text.Trim)
            VerificaMensaje(Mensaje)
