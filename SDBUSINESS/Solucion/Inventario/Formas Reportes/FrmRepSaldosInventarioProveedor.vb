Imports Business
Public Class FrmRepSaldosInventarioProveedor
    ...
    Private Sub LlenaCombos()
        ...
        Try
            ...
            Mensaje = Proveedor.LoadComboBox(CmbProveedor)
            VerificaMensaje(Mensaje)
    ...
    Private Sub MuestraReporte()
        ...
        Dim Reporte As New SaldosInventarioProveedor
        Dim FormaReporte As New FrmReporte
        Dim Cantidad As Double = 0
        Dim Prov_Id As Integer = 0
        Try

            Cursor.Current = Cursors.WaitCursor

            Cantidad = CDbl(TxtCantidad.Text)
            Prov_Id = CmbProveedor.SelectedValue

            With ArticuloBodega
                .Suc_Id = CInt(CmbSucursal.SelectedValue)
                .Bod_Id = CInt(CmbBodega.SelectedValue)
                .Saldo = CDbl(TxtCantidad.Text)
            End With

            Mensaje = ArticuloBodega.RptSaldosInventario(Prov_Id)
            VerificaMensaje(Mensaje)
    ...
    Private Function ValidaTodo() As Boolean
        Try
            ...
            If CmbProveedor.SelectedValue Is Nothing OrElse Not IsNumeric(CmbProveedor.SelectedValue) Then
                VerificaMensaje("Debe de seleccionar el proveedor inicial")
            End If
