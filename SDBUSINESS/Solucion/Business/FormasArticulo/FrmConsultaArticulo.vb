...
#Region "Declaracion Variables"
    ...
    Private Enum ColumnasDetalle
        ...
        FactorConversion = 15
        Exento = 16
        'Cambio para el iva 17 07 2020 LMCG 
        PorcentajeIVA = 17
    End Enum
#End Region
...
#Region "Metodos Privados"
    ...
    Private Sub ConfiguraDetalle()
        ...
        Dim TienePermisoCosto As Boolean = False
        Dim TienePermisoPrecio As Boolean = False
        Try
            With UsuarioPermiso
            ...
            TienePermisoCosto = UsuarioPermiso.RowsAffected > 0

            UsuarioPermiso.Permiso_Id = Permisos.InvAccesoPrecio
            VerificaMensaje(UsuarioPermiso.ListKey())
            TienePermisoPrecio = UsuarioPermiso.RowsAffected > 0
            ...
            With LvwExistencias
                ...
                ' CAMBIO PARA MOSTRAR EL IVA 2020 07 17 LMCG
                '.Columns(ColumnasDetalle.Exento).Text = "ExentoIVA"
                '.Columns(ColumnasDetalle.Exento).Width = 60
                '.Columns(ColumnasDetalle.Exento).TextAlign = HorizontalAlignment.Center


                .Columns(ColumnasDetalle.Exento).Text = "% IVA"
                .Columns(ColumnasDetalle.Exento).Width = 60
                .Columns(ColumnasDetalle.Exento).TextAlign = HorizontalAlignment.Center
    ...
    Private Sub CargaSaldos()
        ...
        Try
            ...
            For Each Fila As DataRow In ArticuloBodega.Data.Tables(0).Rows
                ...
                Items(ColumnasDetalle.Exento) = Format(Fila("Porcentaje"), "#,##0.00")
                'Items(ColumnasDetalle.PorcentajeIVA) = IIf(Fila("ExentoIV"), "Si", "No")
