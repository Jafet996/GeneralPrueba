        ...
        Try
            ...
            If pMestraMensaje Then
                If DGDetalle.Rows.Count = 0 Then
                    If MsgBox("La receta no tiene materias primas, desea continuar?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) <> MsgBoxResult.Yes Then
                        Exit Sub
                    End If
                End If
            End If

            Receta.Art_Id = _CodigoCompuesto.Trim()
            ...
            VerificaMensaje(Receta.ActualizaCosto(TxtCostoCalculado.Text))
