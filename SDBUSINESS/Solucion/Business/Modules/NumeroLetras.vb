Public Module NumeroLetras
    Public Function Letras(ByVal numero As String, tipomoneda As String) As String
        ...
        If Val(numero) <= 999999999 Then
            ...
            For y = Len(dec) To 1 Step -1
                ...
                Select Case y
                    Case 3, 6, 9
                        ...
                        Select Case Mid(dec, num, 1)
                            Case "1"
                                If Mid(dec, num + 1, 1) = "0" And Mid(entero, num + 2, 1) = "0" Then
                                    palabras = palabras & "cien "
                                Else
                                    palabras = palabras & "ciento "
                                End If
                ...
                '***********Asigna la palabra mil***************
                If y = 4 Then
                    If Mid(dec, 6, 1) <> "0" Or Mid(dec, 5, 1) <> "0" Or Mid(dec, 4, 1) <> "0" Or
                    (Mid(dec, 6, 1) = "0" And Mid(dec, 5, 1) = "0" And Mid(dec, 4, 1) = "0" And
                    Len(dec) <= 6) Then palabras = palabras & "mil "
                End If

                '**********Asigna la palabra millón*************
                If y = 7 Then
                    If Len(dec) = 7 And Mid(dec, 1, 1) = "1" Then
                        palabras = palabras & "millón "
                    Else
                        palabras = palabras & "millones "
                    End If
