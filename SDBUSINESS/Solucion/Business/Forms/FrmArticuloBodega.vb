...
Imports Business
Public Class FrmArticuloBodega
    ...
    Private Sub FormateaCamposNumericos()
        Try
            ...
            Numerico(1) = New TNumericFormat(TxtPrecioVenta, 12, 5, False, "0", "#,##0.00")
            ...
            Numerico(6) = New TNumericFormat(TxtPrecioVentaMayorista, 12, 5, False, "0", "#,##0.00")
            Numerico(7) = New TNumericFormat(TxtMargen3, 8, 2, False, "0", "#,##0.00")
            Numerico(8) = New TNumericFormat(TxtPrecioVenta3, 12, 5, False, "0", "#,##0.00")
            Numerico(9) = New TNumericFormat(TxtMargen4, 8, 2, False, "0", "#,##0.00")
            Numerico(10) = New TNumericFormat(TxtPrecioVenta4, 12, 5, False, "0", "#,##0.00")
            Numerico(11) = New TNumericFormat(TxtMargen5, 8, 2, False, "0", "#,##0.00")
            Numerico(12) = New TNumericFormat(TxtPrecioVenta5, 12, 5, False, "0", "#,##0.00")
    ...
    Private Sub CargaArticulo()
        ...
        Try
            ...
            CargaImpuestos(Articulo.Art_Id)
    ...
    Private Sub CargaInformacionBodega()
        ...
        Try
            ...
            CargaImpuestos(ArticuloBodega.Art_Id)
            ...
            With ArticuloBodega
                ...
                'Correcion decimal
                TxtPrecio.Text = Format(.Precio, "#,##0.00000")
                _PrecioAnterior = .Precio
                TxtPrecioMayorista.Text = Format(.PrecioMayorista, "#,##0.00000")
                TxtPrecio3.Text = Format(.Precio3, "#,##0.00000")
                TxtPrecio4.Text = Format(.Precio4, "#,##0.00000")
                TxtPrecio5.Text = Format(.Precio5, "#,##0.00000")
    ...
    Private Sub TxtPrecioVenta_TextChanged(sender As System.Object, e As System.EventArgs) Handles TxtPrecioVenta.TextChanged
        ...
        Try
            ...
            If LCase(LblExento.Text) = "si" Then
                TxtPrecio.Text = Format(PrecioVenta, "#,##0.00000")
            Else
                TxtPrecio.Text = Format(PrecioVenta - RestaMontoImpuesto(PrecioVenta, InfoArticulo.ArticuloImpuestos), "#,##0.00000")
    ...
    Private Sub TxtPrecioVentaMayorista_TextChanged(sender As System.Object, e As System.EventArgs) Handles TxtPrecioVentaMayorista.TextChanged
        ...
        Try
            ...
            'Calcula el monto del precio sin impuesto de venta
            If LCase(LblExento.Text) = "si" Then
                TxtPrecioMayorista.Text = Format(PrecioVenta, "#,##0.00000")
            Else
                TxtPrecioMayorista.Text = Format(PrecioVenta - RestaMontoImpuesto(PrecioVenta, InfoArticulo.ArticuloImpuestos), "#,##0.00000")
            End If
    ...
    Private Sub TxtPrecioVenta3_TextChanged(sender As Object, e As EventArgs) Handles TxtPrecioVenta3.TextChanged
        ...
        Try
            ...
            'Calcula el monto del precio sin impuesto de venta
            If LCase(LblExento.Text) = "si" Then
                TxtPrecio3.Text = Format(PrecioVenta, "#,##0.00000")
            Else
                TxtPrecio3.Text = Format(PrecioVenta - RestaMontoImpuesto(PrecioVenta, InfoArticulo.ArticuloImpuestos), "#,##0.00000")
            End If
    ...
    Private Sub TxtPrecioVenta4_TextChanged(sender As Object, e As EventArgs) Handles TxtPrecioVenta4.TextChanged
        ...
        Try
            ...
            'Calcula el monto del precio sin impuesto de venta
            If LCase(LblExento.Text) = "si" Then
                TxtPrecio4.Text = Format(PrecioVenta, "#,##0.00000")
            Else
                TxtPrecio4.Text = Format(PrecioVenta - RestaMontoImpuesto(PrecioVenta, InfoArticulo.ArticuloImpuestos), "#,##0.00000")
            End If
    ...
    Private Sub TxtPrecioVenta5_TextChanged(sender As Object, e As EventArgs) Handles TxtPrecioVenta5.TextChanged
        ...
        Try
            ...
            'Calcula el monto del precio sin impuesto de venta
            If LCase(LblExento.Text) = "si" Then
                TxtPrecio5.Text = Format(PrecioVenta, "#,##0.00000")
            Else
                TxtPrecio5.Text = Format(PrecioVenta - RestaMontoImpuesto(PrecioVenta, InfoArticulo.ArticuloImpuestos), "#,##0.00000")
            End If
