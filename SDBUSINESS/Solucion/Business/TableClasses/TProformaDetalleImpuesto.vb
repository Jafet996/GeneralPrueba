Public Class TProformaDetalleImpuesto
...
#Region "Definition of Public Methods"
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " update ProformaDetalleImpuesto " &
    ...
    Public Overrides Function Delete() As String
        ...
        Try
            ...
            Query = " delete ProformaDetalleImpuesto" &
                    " where Emp_Id = " & Emp_Id.ToString &
                    " and   Suc_Id = " & Suc_Id.ToString &
                    " and   Documento_Id = " & Documento_Id.ToString &
                    " and   Detalle_Id = " & Detalle_Id.ToString &
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = " select *" &
                    " from ProformaDetalleImpuesto with (nolock)" &
                    " where Emp_Id = " & Emp_Id.ToString &
                    " and   Suc_Id = " & Suc_Id.ToString &
                    " and   Documento_Id = " & Documento_Id.ToString &
                    " and   Detalle_Id = " & Detalle_Id.ToString &
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select * from ProformaDetalleImpuesto with (nolock)"
    ...
    Public Overrides Function LoadComboBox(pCombo As Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = " select ProformaDetalleImpuesto_Id as Numero " &
                    "       ,Nombre" &
                    " from ProformaDetalleImpuesto with (nolock) " &
                    " where Emp_Id = " & Emp_Id.ToString &
                    " and   Activo = 1"
