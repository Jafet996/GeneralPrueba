Public Class TProduccionDetalle
...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into ProduccionDetalle( Emp_Id , Suc_Id" &
                   " , TipoProd_Id , Prod_Id" &
                   " , Detalle_Id , Art_Id" &
                   " , Cantidad , Costo" &
                   " , TotalLinea , Suelto" &
                   ...
                   "," & _Detalle_Id.ToString() & ",'" & _Art_Id & "'" &
                   "," & _Cantidad.ToString() & "," & _Costo.ToString() &
                   "," & _TotalLinea.ToString() & "," & _Suelto.ToString() &
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " Update dbo.ProduccionDetalle " &
                      " SET   Art_Id='" & _Art_Id & "' " & "," &
                      " Cantidad=" & _Cantidad & "," &
                      " Costo=" & _Costo & "," &
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From ProduccionDetalle" &
           " Where     Emp_Id=" & _Emp_Id.ToString() &
           " And    Suc_Id=" & _Suc_Id.ToString() &
           " And    TipoProd_Id=" & _TipoProd_Id.ToString() &
           " And    Prod_Id=" & _Prod_Id.ToString() &
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select a.*, b.Nombre From ProduccionDetalle a, Articulo b where a.Emp_Id = b.Emp_Id and a.Art_Id = b.Art_id" &
                " and a.Emp_Id = " & _Emp_Id.ToString & " and a.Suc_Id = " & _Suc_Id.ToString &
                " and a.TipoProd_Id = " & _TipoProd_Id.ToString & " and a.Prod_Id = " & _Prod_Id.ToString
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select ProduccionDetalle_Id as Numero, Nombre From ProduccionDetalle"
