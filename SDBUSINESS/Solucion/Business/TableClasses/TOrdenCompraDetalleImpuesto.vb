Public Class TOrdenCompraDetalleImpuesto
...
#Region "Definition of Public Methods"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " insert into OrdenCompraDetalleImpuesto ( Emp_Id , Suc_Id" &
                    ...
                    "," & Orden_Id.ToString & "," & Detalle_Id.ToString &
                    ",'" & Codigo_Id & "'" & ",'" & Tarifa_Id & "'" &
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = " select *" &
                    " from OrdenCompraDetalleImpuesto with (nolock)" &
                    " where Emp_Id = " & Emp_Id.ToString &
                    " and   Suc_Id = " & Suc_Id.ToString &
                    " and   Orden_Id = " & Orden_Id.ToString &
                    " and   Detalle_Id = " & Detalle_Id.ToString &
            ...
            If Not Tabla Is Nothing AndAlso Tabla.Rows.Count > 0 Then
                ...
                Orden_Id = Tabla.Rows(0).Item("Orden_Id")
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select * from OrdenCompraDetalleImpuesto with (nolock)"
    ...
    Public Overrides Function LoadComboBox(pCombo As Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = " select OrdenCompraDetalleImpuesto_Id as Numero " &
                    "       ,Nombre" &
                    " from OrdenCompraDetalleImpuesto with (nolock) " &
                    " where Emp_Id = " & Emp_Id.ToString &
                    " and   Activo = 1"
