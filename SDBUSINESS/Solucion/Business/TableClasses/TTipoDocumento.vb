...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into TipoDocumento( Emp_Id , TipoDoc_Id" & _
                   " , Nombre , Activo" & _
                   " , Cliente_Id , UltimaModificacion" & _
                   " )" & _
                   " Values ( " & _Emp_Id.ToString() & "," & _TipoDoc_Id.ToString() & _
                   ",'" & _Nombre & "'" & "," & _Activo.ToString() & _
                   "," & _Cliente_Id.ToString() & ",'" & Format(_UltimaModificacion, "yyyyMMdd HH:mm:ss") & "'" & ")"
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            query = " Update dbo.TipoDocumento " & _
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From TipoDocumento" & _
           " Where     Emp_Id=" & _Emp_Id.ToString() & _
           " And    TipoDoc_Id=" & _TipoDoc_Id.ToString()
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select TipoDoc_Id as Codigo, Nombre From TipoDocumento where Emp_Id = " & _Emp_Id.ToString
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select TipoDoc_Id as Numero, Nombre From TipoDocumento where Emp_Id = " & _Emp_Id.ToString
