Public Class TArticuloAnotacion
...
#Region "Definicion metodos publicos"
    Public Function Siguiente() As String
        ...
        Try
            ...
            Query = "select isnull(max(Anotacion_Id),0) + 1 From ArticuloAnotacion" & _
    ...
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into ArticuloAnotacion( Emp_Id , Art_Id" & _
    ...
    Public Overrides Function Delete() As String
        ...
        Try
            ...
            Query = "Delete ArticuloAnotacion" & _
               " Where     Emp_Id=" & _Emp_Id.ToString() & _
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " Update dbo.ArticuloAnotacion " & _
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From ArticuloAnotacion" & _
           " Where     Emp_Id=" & _Emp_Id.ToString() & _
           " And     Art_Id='" & _Art_Id & "'" & _
           " And    Anotacion_Id=" & _Anotacion_Id.ToString()
    ...
    Public Overrides Function List() As String
        ...
        Try
            ...
            Query = "select * From ArticuloAnotacion"
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select ArticuloAnotacion_Id as Numero, Nombre From ArticuloAnotacion"
