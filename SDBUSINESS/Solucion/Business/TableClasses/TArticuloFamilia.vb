...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into ArticuloFamilia( Emp_Id , Familia_Id" &
                   " , Nombre , Activo" &
                   " , UltimaModificacion )" &
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " Update dbo.ArticuloFamilia " &
                      " SET   Nombre='" & _Nombre & "' " & "," &
                      " Activo=" & _Activo & "," &
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From ArticuloFamilia" &
           " Where     Emp_Id=" & _Emp_Id.ToString() &
           " And    Familia_Id=" & _Familia_Id.ToString()
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select ArticuloFamilia_Id as Numero, Nombre From ArticuloFamilia"
    ...
    Public Function ListaMantenimiento(pNombre As String) As String
        ...
        Try
            ...
            Query = "select Familia_Id as Codigo, Nombre From ArticuloFamilia where Emp_Id = " & _Emp_Id.ToString()
    ...
    Public Function Siguiente() As String
        ...
        Try
            ...
            Query = "select isnull(max(Familia_Id),0) + 1 From ArticuloFamilia Where Emp_Id=" & _Emp_Id.ToString()

            Tabla = Cn.Seleccionar(Query).Copy

            If Not Tabla Is Nothing AndAlso Tabla.Rows.Count > 0 Then
                _Familia_Id = Tabla.Rows(0).Item(0)
            End If
