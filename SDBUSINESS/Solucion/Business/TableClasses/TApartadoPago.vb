...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into ApartadoPago( Emp_Id , Suc_Id" &
                   ...
                   "," & _Pago_Id.ToString() & "," & _TipoPago_Id.ToString() &
                   "," & _Monto.ToString() & "," & _Banco_Id.ToString() &
                   ",'" & _ChequeNumero & "'" & ",'" & Format(_ChequeFecha, "yyyyMMdd HH:mm:ss") & "'" &
                   "," & _Tarjeta_Id.ToString() & ",'" & _TarjetaNumero & "'" &
    ...
    Public Overrides Function ListKey() As String
        ...
        Try
            ...
            Query = "select * From ApartadoPago" &
           " Where     Emp_Id=" & _Emp_Id.ToString() &
           " And    Suc_Id=" & _Suc_Id.ToString() &
           " And    Apartado_Id=" & _Apartado_Id.ToString() &
           " And    Abono_Id=" & _Abono_Id.ToString() &
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select ApartadoPago_Id as Numero, Nombre From ApartadoPago"
    ...
    Public Sub NextOne()
        ...
        Try
            ...
            Query = "select IsNull(MAX(Pago_Id),0) + 1 as Mov_Id From ApartadoPAgo" &
                    " Where Emp_Id = " & _Emp_Id.ToString &
                    " And   Suc_Id = " & Suc_Id &
            ...
            _Pago_Id = CInt(Tabla.Rows(0).Item(0).ToString())
