...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into Distrito( Emp_Id , Provincia_Id" & _
                    " , Canton_Id , Distrito_Id" & _
                    " , Nombre )" & _
                    " Values ( " & _Emp_Id.ToString() & "," & _Provincia_Id.ToString() & _
                    "," & _Canton_Id.ToString() & "," & _Distrito_Id.ToString() & _
                    ",'" & _Nombre & "'" & ")"
    ...
    Public Overrides Function Delete() As String
        ...
        Try
            ...
            Query = "Delete Distrito" & _
                    " Where     Emp_Id=" & _Emp_Id.ToString() & _
                    " And    Provincia_Id=" & _Provincia_Id.ToString() & _
                    " And    Canton_Id=" & _Canton_Id.ToString() & _
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select Distrito_Id as Numero, Nombre From Distrito" & _
                    " where Emp_Id = " & _Emp_Id.ToString & _
                    " and   Provincia_Id = " & Provincia_Id.ToString & _
