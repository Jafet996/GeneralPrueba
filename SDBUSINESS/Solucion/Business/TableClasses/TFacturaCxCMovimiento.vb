Public Class FacturaCxCMovimiento
...
#Region "Definicion metodos publicos"
    Public Overrides Function Insert() As String
        ...
        Try
            ...
            Query = " Insert into FacturaCxCMovimiento( Emp_Id , Suc_Id" &
                   " , Caja_Id , TipoDoc_Id" &
                   " , Documento_Id , CXC_Emp_Id" &
                   " , CXC_Tipo_Doc , CXC_Mov_Id" &
                   " )" &
                   " Values ( " & _Emp_Id.ToString() & "," & _Suc_Id.ToString() &
                   "," & _Caja_Id.ToString() & "," & _TipoDoc_Id.ToString() &
                   "," & _Documento_Id.ToString() & "," & _CXC_Emp_Id.ToString() &
                   "," & _CXC_Tipo_Doc.ToString() & "," & _CXC_Mov_Id.ToString() & ")"
    ...
    Public Overrides Function Delete() As String
        ...
        Try
            ...
            Query = "Delete FacturaCxCMovimiento" &
    ...
    Public Overrides Function Modify() As String
        ...
        Try
            ...
            Query = " Update dbo.FacturaCxCMovimiento " &
    ...
    Public Overrides Function LoadComboBox(pCombo As System.Windows.Forms.ComboBox) As String
        ...
        Try
            ...
            Query = "select FacturaCxCMovimiento_Id as Numero, Nombre From FacturaCxCMovimiento"
