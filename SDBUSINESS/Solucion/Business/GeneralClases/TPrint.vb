...
Public Enum PrintLocation
    ...
    CartaGeneral = 10
    SanMartinPOS = 11
    ServicentroDelCarmen = 12
    PCW = 13
    EVISecurity = 14
    CarnesGarroyRetana = 15
...
#Region "Definicion de Variables Locales"
    ...
    Private _PrintTo As String
#End Region
#Region "Definicion de Propiedades"
    Public Property PrintTo As String
        Get
            Return _PrintTo
        End Get
        Set(value As String)
...
#Region "Metodos para imprimir"
    ...
    Protected Sub Begin_Doc(pOpenCashDrawer As Boolean)
        ...
        Else
            ...
            If _PrintTo.Trim <> String.Empty Then
                _ParaleloPort.PrinterSettings.PrinterName = _PrintTo
            End If
