...
Imports Business
Public Class FrmMantUpcLista
    Private coTitulo = "Upc"
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Upc.ListaMantenimiento(TxtCriterio.Text.Trim)
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = Upc.Data.Tables(0)
    ...
    Private Sub FrmMantUpcLista_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Upc.Upc_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            Mensaje = Upc.Delete()
            VerificaMensaje(Mensaje)
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantUpcDetalle
    ...
    Private Sub TxtCriterio_TextChanged(sender As System.Object, e As System.EventArgs) Handles TxtCriterio.TextChanged
        If TxtCriterio.Text.Trim <> "" Then
            PicBorrar.Image = Global.Business.My.Resources.delete
        Else
