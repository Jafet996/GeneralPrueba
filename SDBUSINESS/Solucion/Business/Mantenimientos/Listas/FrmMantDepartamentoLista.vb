...
Imports Business
Public Class FrmMantDepartamentoLista
    Private coTitulo = "Departamentos"
    ...
    Private Sub FrmMantDepartamentoLista_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Departamento.Departamento_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            Mensaje = Departamento.Delete()
            VerificaMensaje(Mensaje)
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantDepartamentoDetalle
