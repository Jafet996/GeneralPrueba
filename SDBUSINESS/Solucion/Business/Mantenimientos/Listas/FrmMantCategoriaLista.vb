...
Imports Business
Public Class FrmMantCategoriaLista
    Private coTitulo = "Categorías"
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Categoria.List()
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = Categoria.Data.Tables(0)
    ...
    Private Sub FrmMantCategoriaLista_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Categoria.Cat_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantCategoriaDetalle
