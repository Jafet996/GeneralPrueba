...
Public Class FrmMantProveedorLista
    ...
    Public Sub Execute(pModal As Boolean)
        Try
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Proveedor.ListaMantenimiento(TxtCriterio.Text.Trim)
    ...
    Private Sub FrmMantProveedorLista_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Proveedor.Prov_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            Mensaje = Proveedor.Delete()
            VerificaMensaje(Mensaje)
