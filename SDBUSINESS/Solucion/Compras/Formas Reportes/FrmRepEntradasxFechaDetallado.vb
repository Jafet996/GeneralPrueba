Imports Business
Public Class FrmRepEntradasxFechaDetallado
    Private Sub MuestraReporte()
        ...
        Try
            ...
            If InfoMaquina.PrintLocation = PrintLocation.PCW Then

                Reporte = New RptEntradasxFechaDetalladoPCW()

            Else

                Reporte = New RptEntradasxFechaDetallado()
            ...
            End With
            Mensaje = EntradaEncabezado.RptEntradaXFechaDetallado(FechaIni, FechaFin)
