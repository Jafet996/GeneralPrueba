...
Public Class RptVentasXArticulo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptVentasXArticulo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasXArticulo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasXArticulo = New RptVentasXArticulo()
        rpt.Site = Me.Site
        Return rpt
    End Function
