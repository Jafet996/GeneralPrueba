...
Public Class RptCxCAbonoTectel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptCxCAbonoTectel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCxCAbonoTectel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCxCAbonoTectel = New RptCxCAbonoTectel()
        rpt.Site = Me.Site
        Return rpt
    End Function
