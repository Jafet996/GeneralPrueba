...
Public Class RptVentasTipoPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptVentasTipoPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasTipoPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasTipoPago = New RptVentasTipoPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
