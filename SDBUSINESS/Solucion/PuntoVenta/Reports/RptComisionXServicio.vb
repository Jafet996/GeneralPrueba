...
Public Class RptComisionXServicio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptComisionXServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptComisionXServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptComisionXServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptComisionXServicio = New RptComisionXServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
