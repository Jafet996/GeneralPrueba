...
Public Class RptHistorialCliente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptHistorialCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptHistorialCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHistorialCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHistorialCliente = New RptHistorialCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
