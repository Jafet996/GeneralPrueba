...
Public Class RptFacturaPerfumes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptFacturaPerfumes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaPerfumes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaPerfumes = New RptFacturaPerfumes()
        rpt.Site = Me.Site
        Return rpt
    End Function
