...
Public Class RptClienteEncargo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptClienteEncargo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptClienteEncargo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptClienteEncargo = New RptClienteEncargo()
        rpt.Site = Me.Site
        Return rpt
    End Function
