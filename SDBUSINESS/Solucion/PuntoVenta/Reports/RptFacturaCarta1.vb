...
Public Class RptFacturaCarta1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptFacturaCarta1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaCarta1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaCarta1 = New RptFacturaCarta1()
        rpt.Site = Me.Site
        Return rpt
    End Function
