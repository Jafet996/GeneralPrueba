...
Public Class RptVentasEmpresaCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptVentasEmpresaCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasEmpresaCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasEmpresaCR = New RptVentasEmpresaCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
