...
Public Class RptMovimientosPorCajaUsuario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptMovimientosPorCajaUsuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptMovimientosPorCajaUsuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pUsuario_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptMovimientosPorCajaUsuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMovimientosPorCajaUsuario = New RptMovimientosPorCajaUsuario()
        rpt.Site = Me.Site
        Return rpt
    End Function
