...
Public Class RptPrefacturaCarta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptPrefacturaCarta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPrefacturaCarta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPrefacturaCarta = New RptPrefacturaCarta()
        rpt.Site = Me.Site
        Return rpt
    End Function
