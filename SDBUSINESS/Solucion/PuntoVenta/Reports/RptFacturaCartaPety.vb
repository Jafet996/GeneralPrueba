...
Public Class RptFacturaCartaPety
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptFacturaCartaPety.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptFacturaCartaPety.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaCartaPety
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaCartaPety = New RptFacturaCartaPety()
        rpt.Site = Me.Site
        Return rpt
    End Function
