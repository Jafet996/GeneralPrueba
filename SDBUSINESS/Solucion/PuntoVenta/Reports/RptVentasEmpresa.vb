...
Public Class RptVentasEmpresa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptVentasEmpresa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasEmpresa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasEmpresa = New RptVentasEmpresa()
        rpt.Site = Me.Site
        Return rpt
    End Function
