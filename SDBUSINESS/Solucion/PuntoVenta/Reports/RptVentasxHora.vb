...
Public Class RptVentasxHora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptVentasxHora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasxHora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasxHora = New RptVentasxHora()
        rpt.Site = Me.Site
        Return rpt
    End Function
