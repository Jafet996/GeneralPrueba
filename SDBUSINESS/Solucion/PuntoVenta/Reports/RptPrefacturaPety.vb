...
Public Class RptPrefacturaPety
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptPrefacturaPety.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPrefacturaPety
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPrefacturaPety = New RptPrefacturaPety()
        rpt.Site = Me.Site
        Return rpt
    End Function
