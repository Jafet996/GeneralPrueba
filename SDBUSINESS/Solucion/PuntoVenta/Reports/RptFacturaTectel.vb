...
Public Class RptFacturaTectel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptFacturaTectel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaTectel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaTectel = New RptFacturaTectel()
        rpt.Site = Me.Site
        Return rpt
    End Function
