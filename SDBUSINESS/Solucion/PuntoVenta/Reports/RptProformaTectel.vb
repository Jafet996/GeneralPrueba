...
Public Class RptProformaTectel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PuntoVenta.RptProformaTectel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProformaTectel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProformaTectel = New RptProformaTectel()
        rpt.Site = Me.Site
        Return rpt
    End Function
