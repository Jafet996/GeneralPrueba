Imports Business
Public Class FrmMantBancoLista
    Private coTitulo = "Banco"
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Banco.ListaMantenimiento(TxtCriterio.Text.Trim)
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = Banco.Data.Tables(0)
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Banco.Banco_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            Mensaje = Banco.Delete()
            VerificaMensaje(Mensaje)
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantBancoDetalle
