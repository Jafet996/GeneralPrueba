Imports Business
Public Class FrmMantTarjetaLista
    Private coTitulo = "Tarjeta"
    ...
    Private Sub Refrescar()
        ...
        Try
            ...
            Mensaje = Tarjeta.ListaMantenimiento(TxtCriterio.Text.Trim)
            VerificaMensaje(Mensaje)

            DGDetalle.DataSource = Tarjeta.Data.Tables(0)
    ...
    Private Sub FrmMantTarjetaLista_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Tarjeta.Tarjeta_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(0).Value
            Mensaje = Tarjeta.Delete()
            VerificaMensaje(Mensaje)
    ...
    Private Sub Modificar()
        Dim Forma As New FrmMantTarjetaDetalle
