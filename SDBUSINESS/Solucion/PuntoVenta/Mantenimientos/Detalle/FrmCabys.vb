...
Public Class FrmCabys
    ...
    Private _codigoPoducto As String
    ...
    Public ReadOnly Property Tarifa As Double
        ...
        End Get
    End Property
    Public Sub Execute(codigo_prod As String)

        _GuardoCambios = False
        _SucursalNuevo = 0
        _selecciono = False
        _codigo = ""
        _codigoPoducto = codigo_prod
        _Descripcion = ""
        _Tarifa = 0
        Refrescar()
        Categoria1()
    ...
    Private Sub FrmCabys_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Seleccionar()
        Try
            ...
            _selecciono = True
            artic.AsignaCAbysArticulo(_codigoPoducto, _codigo, _Descripcion, _Tarifa)
