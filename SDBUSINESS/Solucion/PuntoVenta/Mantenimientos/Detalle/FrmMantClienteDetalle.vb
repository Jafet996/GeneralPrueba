...
#End Region
    ...
    Private Function ValidaTodo() As Boolean
        ...
        Try
            ...
            If EmpresaParametroInfo.FacturacionElectronica AndAlso EmpresaParametroInfo.FeReceptor AndAlso EmpresaParametroInfo.FeReceptorIdentificacion Then
                ...
                If _Nuevo Then
                    If EmpresaParametroInfo.ValidaCedulaDuplicada Then
                        ClienteTmp.TipoIdentificacion_Id = CmbTipoIdentificacion.SelectedValue
                        ClienteTmp.Cedula = TxtCedula.Text.Trim
                        VerificaMensaje(ClienteTmp.ConsultaClienteCedulaTipo())
                        If ClienteTmp.RowsAffected > 0 Then
                            VerificaMensaje("El número de cédula ya lo tiene asigando el cliente " & ClienteTmp.Data.Tables(0).Rows(0).Item("Cliente_Id") & " - " & ClienteTmp.Data.Tables(0).Rows(0).Item("Nombre"))
                        End If
                    End If
    ...
    Private Sub Guardar()
        Try
            ...
            With Cliente
                ...
                'Cambios Mike: 05/11/2020
                TxtEmail.Text = Replace(TxtEmail.Text, " ", "")
                .Email = TxtEmail.Text
                txtCorreoCotizaciones.Text = Replace(txtCorreoCotizaciones.Text, " ", "")
    ...
    Private Sub ChkFacturaCredito_CheckedChanged(sender As Object, e As EventArgs) Handles ChkFacturaCredito.CheckedChanged
    ...
    Private Sub TxtCxCColones_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtCxCColones.KeyDown
    ...
    Private Sub BtnAnotacionAgregar_Click(sender As Object, e As EventArgs) Handles BtnAnotacionAgregar.Click
    ...
    Private Sub TxtAgregaContacto_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtAgregaContacto.KeyDown
        Try
            Select Case e.KeyCode
                Case Keys.Enter
                    If (TxtAgregaContacto.Text <> "") Then
    ...
    Private Sub LvwAnotaciones_KeyDown(sender As Object, e As KeyEventArgs) Handles LvwAnotaciones.KeyDown
        Try
            Select Case e.KeyCode
                Case Keys.Delete
