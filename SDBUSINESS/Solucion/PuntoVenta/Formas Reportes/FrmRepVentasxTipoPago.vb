Imports Business
Public Class FrmRepVentasxTipoPago
    ...
    Private Sub MuestraReporte()
        ...
        Try
            ...
            Mensaje = FacturaEncabezado.RptVentasxTipoPago(FechaIni, FechaFin)
            ...
            If CbTotalizado.Checked Then
                Reporte = New VentasXTipoPago()
            Else
                Reporte = New RptVentasTipoPago()
            ...
            If CbTotalizado.Checked Then
                ...
                Reporte.SetParameterValue("pHasta", DtpPFechaFin.Value.Date)
