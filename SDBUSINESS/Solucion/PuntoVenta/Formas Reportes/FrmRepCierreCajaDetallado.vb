Imports Business
Public Class FrmRepCierreCajaDetallado
    Public Sub Execute()
    ...
    Private Sub CmbCaja_SelectedValueChanged(sender As Object, e As EventArgs) Handles CmbCaja.SelectedValueChanged
        ...
        Try
            ...
            End With
            Mensaje = CajaCierreEncabezado.CargaCierreCerrado(CmbCierre)
            VerificaMensaje(Mensaje)
    ...
    Private Sub MuestraReporte()
        ...
        Dim Reporte As New RptCierreCajaDetallado
        ...
        Try
            ...
            Mensaje = EntradaEfectivo.RptCierreCajaDetallado()
            VerificaMensaje(Mensaje)
            ...
            Reporte.SetParameterValue("CajaNombre", CmbCaja.Text)
            Reporte.SetParameterValue("CierreNumero", CmbCierre.Text)
