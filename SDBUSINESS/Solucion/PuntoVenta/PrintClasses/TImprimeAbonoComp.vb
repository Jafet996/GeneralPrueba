Imports Business
Public Class TImprimeAbonoComp
    Inherits TPrint
...
#End Region
    ...
    Public Sub New(ByVal pEmpresa As TEmpresa, ByVal pEmpresaParametro As TEmpresaParametro, ByVal pSucursal As TSucursal, ByVal pAbonoEncabezado As TApartadoEncabezado, Optional pReimpresion As Boolean = False)
        MyBase.New()
    ...
    Private Sub ImprimeEncabezado(ByRef y As Integer)
        ...
        If _EsReimpresion Then
            Send("*** REIMPRESIÓN ABONO ***", PrintFont.FontSingle, 1, y, PrintJustification.epsleft, 15)
        End If
        ...
        Send("Fecha: " + Format(_Apartado.Fecha, "dd/MM/yyyy hh:mm:ss tt"), PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        ...
        Send("Cajero: " & _Apartado.Usuario_Id, PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
