Imports Business
Public Class TImprimeSalidaEfectivo
    Inherits TPrint
...
#Region "Declaracion de variables"
    ...
    Private _CajaSalidaEfectivo As TCajaSalidaEfectivo
    Private _Resumido As Boolean
#End Region

    Public Sub New(ByVal pEmpresa As TEmpresa, ByVal pSucursal As TSucursal, pCaja As TCaja, ByVal pCajaCierreEncabezado As TCajaSalidaEfectivo, pResumido As Boolean)
        MyBase.New()
        _Empresa = pEmpresa
        _Sucursal = pSucursal
        _Caja = pCaja
        _CajaSalidaEfectivo = pCajaCierreEncabezado
        _Resumido = pResumido
    End Sub
    ...
    Private Sub ImprimeEncabezado(ByRef y As Integer)
        ...
        Send("Salida de Efectivo", PrintFont.FontTitulo, 1, y, PrintJustification.epsleft, 30)
        ...
        Send("Cierre: " + Format(_CajaSalidaEfectivo.Cierre_Id), PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Send("Cajero: " & _CajaSalidaEfectivo.Usuario_Id, PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Send("Fecha: " + Format(_CajaSalidaEfectivo.Fecha, "dd/MM/yyyy hh:mm:ss tt"), PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)

        If _CajaSalidaEfectivo.Motivo.Length > 0 Then
            Leyenda = "Motivo: " & _CajaSalidaEfectivo.Motivo
        ...
        Send("", PrintFont.FontSingle, 1, y, PrintJustification.epsleft, 10)
        Send("--------------------------------------", PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Send("Total         ", PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Send("--------------------------------------", PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Sleep(100)
        'Send("Motivo: " + _CajaSalidaEfectivo.Motivo, PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
        Send("      Monto: " + CreaStrNumero(_CajaSalidaEfectivo.Monto), PrintFont.FontSingle, 0, y, PrintJustification.epsleft, 15)
