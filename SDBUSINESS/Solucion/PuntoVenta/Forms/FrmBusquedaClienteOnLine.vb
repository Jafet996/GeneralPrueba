Imports Business
Public Class FrmBusquedaClienteOnLine
    ...
    Public ReadOnly Property Vendedor_Id As Integer
        Get
            Return _Vendedor_Id
        End Get
    End Property
    ...
    Private Sub Buscar()
        ...
        Try
            ...
            Mensaje = Cliente.ListBusquedaCliente(TxtCriterio.Text.Trim, tipoBusqueda)
            ...
            DGDetalle.Columns(4).Width = 165
            DGDetalle.Columns(5).Width = 0
    ...
    Private Sub Seleccionar()
        Try
            ...
            _Vendedor_Id = DGDetalle.Rows(DGDetalle.CurrentCell.RowIndex).Cells(5).Value
            _Selecciono = True
            Me.Close()
        Catch ex As Exception
            MensajeError(ex.Message)
